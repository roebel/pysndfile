...
-  Fix: Support libsndfile being installed in the Debian multiarch
   layout when using SNDFILE_INSTALL_DIR or auto detection (it was
   already working when using setup.cfg)
-  Extension: Use pkg-config to locate libsndfile unless
   SNDFILE_INSTALL_DIR is defined
