 ...
 */
  __pyx_t_1 = __Pyx_PyObject_FromString(__pyx_v_buffer); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 419, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     """
 */
  __pyx_tuple__47 = PyTuple_Pack(3, __pyx_int_0, __pyx_int_2, __pyx_int_14); if (unlikely(!__pyx_tuple__47)) __PYX_ERR(0, 34, __pyx_L1_error)
