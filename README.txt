 ...
 * the data is read into float or double and
 * the audio data comes close to the maximum range such that the difference in scaling leads to modifcation.
